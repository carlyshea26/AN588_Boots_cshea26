---
title: "mfinn13_PeerCommentary_cshea26"
...
#Matteo: Nice. My lm got the same coefficients. 
...
#Matteo: wow this is so much simpler and more efficient than the way I did. I was not aware that there was a boot function within {boot} that does the bootstrapping for you. very cool. I did some for loops and kept having issues with it :(

#Matteo: very nice plots. I like that it includes q-q plots showing normality. 
```
...
#Matteo: this is a super cool function and makes it so easy! 
#Matteo: My CIs are centered around the same estimates but mine are much tighter, which I think is because I did it manually and while doing that I calculated standard error incorrectly, so yours are probably good. 
...
#Matteo: very in-depth answer. nice! i just compared the values lol. 
...
**Comparison**: The 95% CIs from both methods are pretty close, supporting that the data likely meet the assumptions of linear regression. we see slope interval of 95% CIs for the bootstrapping is slightly narrower. 

#Matteo: very nice. mine were not very similar to the CIs from the lm but again I think that is because I calculated standard error incorrectly. 

#Matteo: overall very nice job. your code is super efficient and easy to follow and from what i can tell all of the outputted values are correct. 
