...
```
> Jon's Comment: Nice use of the boot package and a well-constructed function for bootstrapping. Love the visualizations of the histogram and density plot. Makes it more aesthetic.
...
\^ i really like this function/command and makes visualizing these confidence intervals very clear and straightforward! *Jon's Comment: "I see what you mean. I really like it too. It's very clear and easy to interpret."*
...
# Jon's Comment: Looks good. I think you have a good foundation set, and it seems well organized. It's clean and readable. The R Markdown is well-structured, with clear section headers and brief explanations in between code blocks. Nice touch with visuals! Adding the gif and custom styling.
